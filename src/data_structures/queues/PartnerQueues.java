...
public class PartnerQueues {
    ...
    /**
     * This method matches defines the number of participants, then collects each participants name using
    ...
    /**
     * This method matches two groups of people into partners, based on who were first into their queue (FIFO).
     */
